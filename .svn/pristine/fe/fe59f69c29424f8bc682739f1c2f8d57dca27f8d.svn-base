...
export class PageSortComponent implements OnInit {
  ...
  addRecords(pCheckValidation: boolean) {
    ...
    // this.pageSortDataSource._updateChangeSubscription();
    // this.pageSortDataSource.data.push(row);
    // this.pageSortDataSource.next(row);
    // this.pageSortDataSource.data.push(row);
    // this.pageSortDataSource.
    // console.log('this.pageSortDataSource', this.pageSortDataSource);
  }

  onSubmit = function(form: PageSortComponent) {
  ...
  onDelete = function(id: number) {
    ...
    console.log('data', this.pageSortData);
    this.pageSortDataSource.data = [...this.pageSortData];
  };
}
